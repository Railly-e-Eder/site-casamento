class Pix {
  constructor(pixKey, description, merchantName, merchantCity, amount) {
    this.pixKey = pixKey;
    this.description = description;
    this.merchantName = merchantName;
    this.merchantCity = merchantCity;
    this.txid = this._generateTxId() || "1234124123";
  ...
  _generateTxId() {
    return this._rand(20); // Retorna uma string aleatória com 20 caracteres
  }
